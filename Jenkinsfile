  ...
  stages {
    ...
    stage('Start Container') {
            steps {
                    ...
                    sh "docker run --rm -v $TRANSFORMATION_FILE:/data/helloworld.ktr -v $CONFIG_FILE:/root/.kettle pentahodi:latest /bin/bash -c './data-integration/Kitchen.sh /file:/data/helloworld.ktr'"
            }
        }
